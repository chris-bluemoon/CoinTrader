...
class Poloniex:
    ...
    # total         Total value of order (price * quantity)
    # type          sell or buy
    def returnTradeHistory(self,currencyPair,startTime,endTime):
        return self.api_query('returnTradeHistory',{"currencyPair":currencyPair,"start":startTime,"end":endTime})
